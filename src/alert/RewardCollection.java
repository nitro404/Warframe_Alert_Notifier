...
//		new Reward("Forma", RewardType.Item, RewardCategory.Item),
		...
		new Reward("Enigma Loki Helmet", RewardType.Blueprint, RewardCategory.HelmetBlueprint),
		...
		new Reward("Slipstream Nova Helmet", RewardType.Blueprint, RewardCategory.HelmetBlueprint),
